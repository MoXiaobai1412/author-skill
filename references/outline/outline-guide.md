...
| 大纲级别     | 存储目录                         | 标准示例模板路径                                        |
|----------|------------------------------|-------------------------------------------------|
| 大纲       | `~/.book/大纲/大纲.md`             | `reference/outline/book-outline-template.md`    |
| 分卷卷纲     | `~/.book/大纲/第[X]卷/卷纲.md`       | `reference/outline/volume-outline-template.md`  |
| 章节章纲     | `~/.book/大纲/第[X]卷/第[Y]章/章纲.md` | `reference/outline/chapter-outline-template.md` |
